...
import 'package:repair_plus_one/iphone_air_repair_screen.dart';

class ApplePhoneScreen extends StatelessWidget {
  const ApplePhoneScreen({Key? key}) : super(key: key);
          ...
          children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 6),
                            Text(
                              "Everything you need to repair your iPhone yourself with free repair guides, and quality replacement parts and tools!",
                              style: TextStyle(
            ...
            Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const IPhoneAirRepairScreen())),
                  child: categoryCard("images/apple/a1.png", "iPhone Air"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ApplePhoneScreen())),
                  child: categoryCard("images/apple/a2.png", "iPhone 17 Pro Max"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ApplePhoneScreen())),
                  child: categoryCard("images/apple/a3.png", "iPhone 17 Pro"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ApplePhoneScreen())),
                  child: categoryCard("images/apple/a4.png", "iPhone 17"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ApplePhoneScreen())),
                  child: categoryCard("images/apple/a5.png", "iPhone 16e"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ApplePhoneScreen())),
                  child: categoryCard("images/apple/a6.png", "iPhone 16"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ApplePhoneScreen())),
                  child: categoryCard("images/apple/a7.png", "iPhone XR"),
                  ),
                ],
              ),
            ),

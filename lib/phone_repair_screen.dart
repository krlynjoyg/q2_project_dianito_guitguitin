...
import 'package:repair_plus_one/landline_phone_screen.dart';
import 'package:repair_plus_one/linux_phone_screen.dart';
import 'package:repair_plus_one/phone_accessories_screen.dart';
import 'package:repair_plus_one/windows_phone_screen.dart';

class PhoneRepairScreen extends StatelessWidget {
  const PhoneRepairScreen({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PhoneAccessoriesScreen())),
                    child: categoryCard("images/phones/phone5.png", "Phone Accessories"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const LandlinePhoneScreen())),
                  child: categoryCard("images/phones/phone6.png", "Landline Phone"),
                  ),
                  GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const LinuxPhoneScreen())),
                  child: categoryCard("images/phones/phone7.png", "Linux Phone"),
    ),
                ],
              ),
            ),
